...
namespace callmez\storage\storages;

use yii\base\NotSupportedException;
use callmez\storage\StorageInterface;
...
abstract class AbstractStorage implements StorageInterface
{
    ...
    {
        throw new NotSupportedException(get_class($this).' does not support visibility settings.');
    }
